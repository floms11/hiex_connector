...
class HiExConnector(HiExConnectorBase):
    ...
    def admin_application_update(self, application_id, available_methods=Empty, interest=Empty, update_keys=Empty, name=Empty, notification_url=Empty, user_id=Empty):
        """
        Редагувати додаток
