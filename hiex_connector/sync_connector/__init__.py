...
class HiExConnector(HiExConnectorBase):
    ...
    def admin_pair_create(self, currency1, currency2, comment, kyc_required, swap_deposit, active=Empty, interest=Empty, max_amount1=Empty, max_amount2=Empty, min_amount1=Empty, min_amount2=Empty, swap_service_info: str = Empty):
        """
    ...
    def admin_pair_update(self, currency1, currency2, active=Empty, comment=Empty, interest=Empty, max_amount1=Empty, max_amount2=Empty, min_amount1=Empty, min_amount2=Empty, kyc_required=Empty, swap_deposit=Empty, swap_service_info: str = Empty):
        """
