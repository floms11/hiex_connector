...
class SyncUser(SyncBase, User):
    pass


class SyncUserWithAuthKey(BaseWithAuthKey, SyncUser):
    def reload(self):
        """
        ...
        :return: bool
        """
        o = self.connector.user_get(self.auth_key)
        super().__init__(**o.get_dict())
        return True

    def referrals(self, limit=Empty, offset=Empty):
        """
        ...
        :return: list
        """
        return self.connector.user_referrals_list(self.auth_key, limit, offset)
    ...
    def logout(self):
        ...
        :return: bool
        """
        return self.connector.user_logout(self.auth_key)

    def kyc_get(self, method, option=Empty, return_url=Empty):
        """
        Отримати лінк для проходження KYC (верифікації)

        :return: Verification
        """
        return self.connector.user_kyc_get(self.auth_key, method, option, return_url)

    def kyc_methods_list(self):
        """
        Завантажити можливі способи проходження верифікації

        :return: ResponseList[VerificationService]
        """
        return self.connector.user_kyc_methods_list(self.auth_key)

    def exchanges(self, limit=Empty, offset=Empty, status_list=Empty, short_exchange_id=Empty):
        """
        ...
        :return:
        """
        return self.connector.user_exchanges_list(self.auth_key, limit, offset, status_list, short_exchange_id)
    ...
    def exchange(self, exchange_id):
        ...
        :return: Exchange
        """
        return self.connector.exchange_get(exchange_id, auth_key=self.auth_key)
    ...
    def exchange_create(
        ...
        :return: Exchange
        """
        return self.connector.user_exchange_create(
            self.auth_key,
            pair.currency1.code,
            pair.currency2.code,
            address,
    ...
    def data_save(self, **kwargs):
        ...
        :return: bool
        """
        self.connector.user_data_save(self.auth_key, **kwargs)
        return True
